...
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[0]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[0]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[1]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[1]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[2]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[2]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[3]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[3]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[4]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[4]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[5]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[5]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[6]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[6]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[7]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[7]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[8]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[8]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[9]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[9]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[10]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[10]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[11]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[11]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[12]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[12]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[13]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[13]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[14]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[14]}]
set_input_delay -add_delay -max -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  3.000 [get_ports {OTG_DATA[15]}]
set_input_delay -add_delay -min -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[15]}]
...
#OTG delays
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[0]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[1]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[2]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[3]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[4]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[5]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[6]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[7]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[8]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[9]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[10]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[11]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[12]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[13]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[14]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_DATA[15]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_ADDR[0]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_ADDR[1]}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_CS_N}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_RD_N}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_RST_N}]
set_output_delay -add_delay  -clock [get_clocks {nios_system|sdram_pll|sd1|pll7|clk[0]}]  2.000 [get_ports {OTG_WR_N}]
...
set_false_path -from [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_nios2_oci_break:the_fp_soc_nios2_qsys_0_nios2_oci_break|break_readreg*}] -to [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_jtag_debug_module_wrapper:the_fp_soc_nios2_qsys_0_jtag_debug_module_wrapper|fp_soc_nios2_qsys_0_jtag_debug_module_tck:the_fp_soc_nios2_qsys_0_jtag_debug_module_tck|*sr*}]
set_false_path -from [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_nios2_oci_debug:the_fp_soc_nios2_qsys_0_nios2_oci_debug|*resetlatch}] -to [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_jtag_debug_module_wrapper:the_fp_soc_nios2_qsys_0_jtag_debug_module_wrapper|fp_soc_nios2_qsys_0_jtag_debug_module_tck:the_fp_soc_nios2_qsys_0_jtag_debug_module_tck|*sr[33]}]
set_false_path -from [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_nios2_oci_debug:the_fp_soc_nios2_qsys_0_nios2_oci_debug|monitor_ready}] -to [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_jtag_debug_module_wrapper:the_fp_soc_nios2_qsys_0_jtag_debug_module_wrapper|fp_soc_nios2_qsys_0_jtag_debug_module_tck:the_fp_soc_nios2_qsys_0_jtag_debug_module_tck|*sr[0]}]
set_false_path -from [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_nios2_oci_debug:the_fp_soc_nios2_qsys_0_nios2_oci_debug|monitor_error}] -to [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_jtag_debug_module_wrapper:the_fp_soc_nios2_qsys_0_jtag_debug_module_wrapper|fp_soc_nios2_qsys_0_jtag_debug_module_tck:the_fp_soc_nios2_qsys_0_jtag_debug_module_tck|*sr[34]}]
set_false_path -from [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_nios2_ocimem:the_fp_soc_nios2_qsys_0_nios2_ocimem|*MonDReg*}] -to [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_jtag_debug_module_wrapper:the_fp_soc_nios2_qsys_0_jtag_debug_module_wrapper|fp_soc_nios2_qsys_0_jtag_debug_module_tck:the_fp_soc_nios2_qsys_0_jtag_debug_module_tck|*sr*}]
set_false_path -from [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_jtag_debug_module_wrapper:the_fp_soc_nios2_qsys_0_jtag_debug_module_wrapper|fp_soc_nios2_qsys_0_jtag_debug_module_tck:the_fp_soc_nios2_qsys_0_jtag_debug_module_tck|*sr*}] -to [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_jtag_debug_module_wrapper:the_fp_soc_nios2_qsys_0_jtag_debug_module_wrapper|fp_soc_nios2_qsys_0_jtag_debug_module_sysclk:the_fp_soc_nios2_qsys_0_jtag_debug_module_sysclk|*jdo*}]
set_false_path -from [get_keepers {sld_hub:*|irf_reg*}] -to [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_jtag_debug_module_wrapper:the_fp_soc_nios2_qsys_0_jtag_debug_module_wrapper|fp_soc_nios2_qsys_0_jtag_debug_module_sysclk:the_fp_soc_nios2_qsys_0_jtag_debug_module_sysclk|ir*}]
set_false_path -from [get_keepers {sld_hub:*|sld_shadow_jsm:shadow_jsm|state[1]}] -to [get_keepers {*fp_soc_nios2_qsys_0:*|fp_soc_nios2_qsys_0_nios2_oci:the_fp_soc_nios2_qsys_0_nios2_oci|fp_soc_nios2_qsys_0_nios2_oci_debug:the_fp_soc_nios2_qsys_0_nios2_oci_debug|monitor_go}]
